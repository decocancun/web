...
?>
    ...
    <div class="galeria"> 
      <div class="contenedor-images">
        ...
        <div class="imagen">
          <a href="weddings/weddings.html">
            <img src="images/events/customized-8.jpg" alt="">
            <div class="overlay">
                <span>Weddings</span>
            </div>
          </a>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12 d-md-none  col-lg-6 d-lg-block m-img">
          ...
          <div class="col-md-12 md-d-none col-lg-6  bg-white p-md-5 align-self-center ">
            <h1 class="display-1  line-height-1 site-section-heading mb-3 pb-3 m-title">Zúñiga Productions and Events</h1>
            ...
            <p class="btn-title">
              <a href="contact-us.php" class="btn btn-black py-3 px-5 ">Book Now!</a>
            </p>
          </div>
        </div>
      </div>
