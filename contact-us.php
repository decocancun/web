...
?>
    <div class="title-contact d-flex justify-content-center align-items-center">
        <h4>CONTACT US</h4>
        <p>If you need more information, don't doubt to contact us.<br> we can make your dream come true.</p>
    </div>
                        ...
                        <form id="formDatos">
                            ...
                            <div class="row form-group d-flex justify-content-end">
                                <div class="col-md-12 d-flex justify-content-end">  
                                    <button type="button" class="btn buton_enviar py-2 px-4" onclick='saveData("ok");'>Send</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="info-contact">
            <span>Branch Offices</span>
                <ul class="branch-office">
                    <li><span class="icon-check"></span> Cancun</li>
                    <li><span class="icon-check"></span> Riviera Maya</li>
                    <li><span class="icon-check"></span> Costa Mujeres</li>
                    <li><span class="icon-check"></span> Los Cabos</li>
                </ul>
            <span>Email Address</span>
                <ul class="branch-office">
                    <li><span class="icon-check"></span> info@decocancun.com</li>
                    <li><span class="icon-check"></span> info@decocabos.com</li>
                </ul>
        </div>
    </div>
